...
?>
		<div class="analytify_general_status analytify_status_box_wraper">
	  	<div class="analytify_status_header">
			<h3><?php  _e( 'Top countries by views.', 'wp-analytify-dashboard-widget' ); ?></h3>
	  	</div>
			...
			<table class="analytify_data_tables wp_analytify_paginated">
				<thead>
					<tr>
						...
						<th class="analytify_txt_left"><?php esc_html_e( 'Countries', 'wp-analytify-dashboard-widget' ); ?></th>
