...
function pa_include_keywords_stats( $current, $top_stats ) {
?>
		<div class="analytify_general_status analytify_status_box_wraper">
	  	<div class="analytify_status_header">
			<h3><?php echo _e( 'Top keywords by views.', 'wp-analytify' ); ?></h3>
	  	</div>
			...
			<table class="analytify_data_tables wp_analytify_paginated">
				<thead>
					<tr>
						...
						<th class="analytify_txt_left"><?php esc_html_e( 'Keywords', 'wp-analytify' ); ?></th>
