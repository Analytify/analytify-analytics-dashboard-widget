...
function pa_include_reffers_stats( $current, $top_stats ) {
?>
		<div class="analytify_general_status analytify_status_box_wraper">
	  	<div class="analytify_status_header">
			<h3><?php _e( 'Top reffers by views.', 'analytify-analytics-dashboard-widget' ); ?></h3>
	  	</div>
			...
			<table class="analytify_data_tables wp_analytify_paginated">
				<thead>
					<tr>
						...
						<th class="analytify_txt_left"><?php analytify_e( 'Top Referrers', 'analytify-analytics-dashboard-widget' ); ?></th>
